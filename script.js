...
// closemoreMusicBtn = container.querySelector("#close");
...
const container = document.querySelector(".container"),
    ...
    moreMusicBtn = container.querySelector("#more-music"),
    closemoreMusicBtn = container.querySelector("#close"),
    startPlaybackBtn = document.querySelector(".top-chart .item .actions #startPlayback");

let musicIndex = 1; // Initial music index
...
// Function to start playback from top-chart
    ...
    topChartItems.forEach(item => {
        ...
        if (playBtn) {
            playBtn.addEventListener("click", () => {
                ...
                // Find the index of the song in allMusic array
                const songIndex = allMusic.findIndex(music => music.name === songName && music.artist === songArtist) + 1;
